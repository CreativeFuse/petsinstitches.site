...
<div class="c-accordion c-accordion--fancy js-expand-accordion <?php echo $service_name; ?>" href="#">

	<div class="c-accordion--fancy__container">

		<div class="c-accordion--fancy__header u-clearfix">

			<h3 class="e-h3 c-accordion--fancy__title"><?php echo esc_html( $output['term_name'] ); ?></h3>
			<p class="e-p--common c-accordion--fancy__description"><?php echo esc_html( $output['term_description'] ); ?></p>
