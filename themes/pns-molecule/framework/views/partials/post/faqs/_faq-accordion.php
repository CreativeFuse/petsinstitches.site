...
<div <?php post_class( array( 'c-accordion', 'c-accordion--simple c-accordion--simple--1' ), $output['faq_id'] ); ?>>

	<div class="c-accordion--simple__header">

		<h5 class="e-h6 c-accordion--simple__header__title u-text-up"><?php echo $output['faq_title']; ?></h5>
	...
	<div class="c-accordion--simple__body u-clearfix">
		...
		<div class="e-p--common c-accordion--simple__content">
			<?php echo $answer; ?>
		</div>
