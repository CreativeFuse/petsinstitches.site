...
$getting_started_faqs = $faqs[40];
$limit = 0;
?>


<div class="o-section p-alt-getting-started--faqs">
				...
				<div class="c-faqs">
					...
					<div class="p-faq__section">
						...
						<h2 class="e-h2 c-faq__ssection__title u-color--blue u-align--center">
							<?php echo esc_html( $getting_started_faqs['topic_name'] ) . ' FAQs';?>
						</h2>

						<?php 

							// loop over FAQ post for this term
							foreach ( $getting_started_faqs['faqs'] AS $faq_list ) :
								// if($limit++==3) break;
