			...
			<div class="o-row o-row__tee-up">
				...
				<div class="o-col-md-12">
					...
					<div class="c-tile-group">
						...
						<a class="c-title-group__media" href="<?php echo esc_url( $group['intro_video_url'] ); ?>" data-rel="lightcase">

							<img class="c-photo c-photo--video c-title-group__media__img" src="<?php echo Molecule_Router::get_img_meta( 'acf', 'url', 'stray_cats_intro_video_img' ); ?>">
									...
									<div class="o-col-md-12">
										...
										<ul class="c-list-paws c-list-paws--blue">
											...
											<?php while( have_rows( 'list' ) ){
												...
												<li class="e-p--common c-list-paws__item u-max-width--700"><?php echo wp_kses_post( $item ); ?></li>
