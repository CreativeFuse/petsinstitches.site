<div class="o-hero o-hero--home" style="background-image:url( <?php echo Molecule_Router::get_img_meta( 'post', 'url' );?>)">
	...
	<div class="o-container o-container--max">
		...
		<div class="o-row">
			...
			<div class="o-col-md-12">
				...
				<div class="c-title-group c-title-group--hero u-max-width--300">
